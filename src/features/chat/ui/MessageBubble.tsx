...
function renderMessagePresentation(
  children: ReactNode,
  isSessionNotification: boolean,
  sender?: string,
): ReactNode {
  return isSessionNotification ? (
    <SessionNotificationDisclosure sender={sender}>
      {children}
            ...
            {showMessageActions ? (
              ...
              >
                <MessageBubbleActions
                  ...
                  onForkFromMessage={
                    !isStreaming ? onForkFromMessage : undefined
                  }
